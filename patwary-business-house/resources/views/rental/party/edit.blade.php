...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Update Party Information</h2>
    </div>
...
<div class="clearfix">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Update Party Information</h3>
        </div>
        <div class="panel-body">
            {!! Form::open(['method' => 'PUT', 'url' => 'rental/party/'.$data->id, 'class' => 'form-horizontal']) !!}
            {{ csrf_field() }}
            <div class="form-group">
                <label  class="col-md-4 control-label">Rental Date</label>
                <div class="col-md-6">
                    <input type="text" class="form-control pickdate" name="rental_date" value="{{ date_dmy($data->rental_date) }}" required readonly>
                ...
                <div class="col-md-6">
                    <select name="flat_id" id="flat_id" class="form-control" required="required">
                        ...
                        <?php foreach ($flats as $flat): ?>
                            <option value="{{ $flat->id }}" @if($flat->id == $data->flat_id) {{ 'selected' }} @endif>{{ $flat->flat_name }}</option>
                        <?php endforeach ?>
                    </select>
                    <small class="text-danger">{{ $errors->first('floor_id') }}</small>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="number" class="form-control" name="monthly_rent" value="{{ $data->monthly_rent }}" required>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" name="party_name" value="{{ $data->party_name }}" required>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="number" class="form-control" name="mobile_no" value="{{ $data->mobile_no }}" required>
