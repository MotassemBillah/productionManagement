...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Party List</h2>
    </div>
        ...
        <tbody>
            <tr>
                ...
                <td class="text-right wmd_30" style="">
                    <a href="{{ url ('rental/party/create') }}"><button class="btn btn-success btn-xs"><i class="fa fa-plus"></i> New</button></a>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#search").click(function () {
            var _url = "{{ URL::to('rental/party/search') }}";
            var _form = $("#frmSearch");
        ...
        $("#Del_btn").click(function () {
            var _url = "{{ URL::to('rental/party/delete') }}";
            var _form = $("#frmList");
