...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Update Floor Information</h2>
    </div>
...
<div class="clearfix">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            {!! Form::open(['method' => 'PUT', 'url' => 'rental/floor/'.$data->id, 'class' => 'form-horizontal']) !!}
            {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" name="floor_name" value="{{ $data->floor_name }}" required>
