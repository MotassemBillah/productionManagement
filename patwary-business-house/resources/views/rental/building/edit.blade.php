...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Update Building Information</h2>
    </div>
...
<div class="clearfix">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Update Building Information</h3>
        </div>
        <div class="panel-body">
            {!! Form::open(['method' => 'PUT', 'url' => 'rental/building/'.$data->id, 'class' => 'form-horizontal']) !!}
            {{ csrf_field() }}
                ...
                <div class="col-md-6">
                    <select name="building_type" id="buildingType" class="form-control" required="required">
                        ...
                        <?php foreach (building_type_list() as $type): ?>
                            <option value="{{ $type }}" @if($type == $data->building_type) {{ 'selected' }} @endif>{{ $type }}</option>
                        <?php endforeach ?>
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" name="building_name" value="{{ $data->building_name }}" required>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" name="building_no" value="{{ $data->building_no }}" required>
