        ...
        <tbody>
            <tr>
                ...
                <td class="text-right wmd_30" style="">
                    <a class="btn btn-success btn-xs xsw_33" href="{{ url ('/particulars/create') }}"><i class="fa fa-plus"></i> New</a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center hip">
                            ...
                            <a class="btn btn-primary btn-xs" href="{{ url('ledger/particular/'.$data->id) }}">Ledger</a>
                        </td>
                        <td class="text-center hip">
