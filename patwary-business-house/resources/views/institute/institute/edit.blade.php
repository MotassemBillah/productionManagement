...
<div class="clearfix">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            {!! Form::open(['method' => 'PUT', 'url' => 'institute/'.$data->id, 'id' => 'frm_institute'  , 'class' => 'form-horizontal']) !!}
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <select name="business_type" id="input" class="form-control" required>
                        ...
                        <option value="{{ $bs->id }}" @if($bs->id == $data->business_type_id) {{ ' selected'}} @endif>{{ $bs->business_type }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
