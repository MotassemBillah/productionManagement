...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-3 col-sm-3 col-xs-4 cxs_12 no_pad">
        <ul class="text-right no_mrgn">
            <li><a href="{{ url('/home') }}"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a> <span class="divider">/</span></li><li><span> Purchase</span></li>
        </ul>                            
    </div>
</div>
<div class="well">
        ...
        <tbody>
            <tr>
                ...
                <td class="text-right" style="width:20%">
                    <a href="{{ url ('oven/purchase-challan/create') }}"><button class="btn btn-success btn-xs"><i class="fa fa-plus"></i> New</button></a>
...
<div class="order-list"> 
    ...
    <div id="print_area">
        <?php print_header("Purchase Challan Information"); ?>
        <div id="ajax_content">
                ...
                <table class="table table-bordered tbl_thin" id="check">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">{{ $data->total_weight }}</td>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search").click(function () {
            var _url = "{{ URL::to('oven/purchase-challan/search') }}";
            var _form = $("#frmSearch");
        ...
        $("#Del_btn").click(function () {
            var _url = "{{ URL::to('oven/purchase-challan/delete') }}";
            var _form = $("#frmList");
