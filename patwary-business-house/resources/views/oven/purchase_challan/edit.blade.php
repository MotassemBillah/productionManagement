...
{!! Form::open(['method' => 'PUT', 'url' => 'oven/purchase-challan/'.$data->id, 'id'=>'frm_purchase', 'class' => 'form-horizontal']) !!}
{{ csrf_field() }}
    ...
    <table class="table table-bordered tbl_thin" id="check">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><input type="number" step="any" class="form-control text-center qty" id="bag_quantity_{{ $product->id }}" data-weight="{{ $product->weight }}" data-info="{{ $product->id }}" name="bag_quantity[{{ $product->id }}]" value="{{ $product->quantity }}"></td>
                <td><input type="number" class="form-control text-center" id="net_weight_{{ $product->id }}" name="net_weight[{{ $product->id }}]" value="{{ $product->net_weight }}" readonly></td> 
            </tr>
            @endforeach
        </tbody>
    </table>
