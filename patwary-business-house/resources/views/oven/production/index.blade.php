        ...
        <tbody>
            <tr>
                ...
                <td class="text-right" style="width:20%">
                    <a href="{{ url ('oven/production/create') }}"><button class="btn btn-success btn-xs"><i class="fa fa-plus"></i> New</button></a>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search").click(function () {
            var _url = "{{ URL::to('oven/production/search') }}";
            var _form = $("#frmSearch");
        ...
        $("#Del_btn").click(function () {
            var _url = "{{ URL::to('oven/production/delete') }}";
            var _form = $("#frmList");
