...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Empty Bag List</h2>
    </div>
        ...
        <tbody>
            <tr>
                ...
                <td class="text-right" style="width:32%">
                    <a class="btn btn-success btn-xs" href="{{ url('/rice/emptybags/create/d') }}"><i class="fa fa-plus"></i>&nbsp;Receive</a>
                    <a class="btn btn-warning btn-xs" href="{{ url('/rice/emptybags/create/c') }}"><i class="fa fa-minus"></i>&nbsp;Payment</a>
...
<div id="print_area">
    <?php print_header("Empty Bag Information"); ?>
    <div id="ajax_content">
            ...
            <table class="table table-bordered tbl_thin" id="check">
                <tbody>
                    ...
                    <tr class="bg_gray">
                        ...
                        <th class="text-right">{{ $total_bag_price }}</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search").click(function () {
            var _url = "{{ URL::to('emptybags/search') }}";
            var _form = $("#frmSearch");
        ...
        $("#Del_btn").click(function () {
            var _url = "{{ URL::to('emptybags/delete') }}";
            var _form = $("#frmList");
