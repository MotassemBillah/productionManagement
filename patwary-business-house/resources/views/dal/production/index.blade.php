        ...
        <tbody>
            <tr>
                ...
                <td class="text-right" style="width:20%">
                    <a href="{{ url ('dal/production/create') }}"><button class="btn btn-success btn-xs"><i class="fa fa-plus"></i> New</button></a>
                    <?php if (has_user_access('dal_production_delete')) : ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center hip">
                                <?php if ($process_status == 'Pending'): ?>
                                    ...
                                    <?php if (has_user_access('dal_production_confirm')) : ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search").click(function () {
            var _url = "{{ URL::to('dal/production/search') }}";
            var _form = $("#frmSearch");
        ...
        $("#Del_btn").click(function () {
            var _url = "{{ URL::to('dal/production/delete') }}";
            var _form = $("#frmList");
