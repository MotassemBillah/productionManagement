...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Purchase Ledger</h2>
    </div>
        ...
        <tbody>
            <tr>
                        ...
                        <div class="input-group-btn clearfix">
                            ...
                            <div style="width:13%;" class="col-md-2 col-sm-3 no_pad">
                                <select id="sortBy" class="form-control" name="search_by_customer">
                                    ...
                                    @foreach( $particular->where('head_id', HEAD_CREDITORS)->get() as $head )
                            ...
                            <input type="text" style="width:120px;" name="order" id="q" class="form-control" placeholder="search challan" size="30"/>
                ...
                <td class="text-right" style="width:20%">
                    <a href="{{ url ('purchases/create') }}"><button class="btn btn-success btn-xs"><i class="fa fa-plus"></i> New</button></a>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search").click(function () {
            var _url = "{{ URL::to('purchase/ledger/search') }}";
            var _form = $("#frmSearch");
