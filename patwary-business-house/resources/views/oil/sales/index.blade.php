                            ...
                            <td class="text-center hip">
                                <?php if ($process_status == 'Pending'): ?>
                                    ...
                                    <?php if (has_user_access('sale_confirm')) : ?>
                                        <a class="btn btn-primary btn-xs" href="sales/{{ $data->id }}/confirm" onClick="return confirm('Are you sure, Sales Complete? This cannot be undone!');" ><i class="fa fa-gavel"></i> Process</a>
                                    <?php endif; ?>
                                <?php else : ?>
                                    <a class="btn btn-success btn-xs" href="sales/{{ $data->id }}"><i class="fa fa-plus"></i> View</a>  
                                    <?php if (has_user_access('sale_confirm')) : ?>
