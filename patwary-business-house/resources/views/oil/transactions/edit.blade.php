            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                <input type="text" id="datepicker" class="form-control pickdate" name="transaction_date" value="{{ date_dmy($data->pay_date) }}" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                <input type="number" id="debit_amount" class="form-control" name="amount" min="0" value="{{ $data->amount }}" required>
