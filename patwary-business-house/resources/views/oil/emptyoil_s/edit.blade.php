...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Update Empty Bag ({{ $title }} Voucher)</h2>
    </div>
...
<div class="col-md-12">
    <div class="panel panel-default">
        ...
        <div class="panel-body {{$pbg}}">
            {!! Form::open(['method' => 'PUT', 'url' => 'emptybags/'.$data->id, 'id' => 'frmEmptyBags'  , 'class' => 'form-horizontal']) !!} 
            {{ csrf_field() }}
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                <input type="text" id="datepicker" class="form-control pickdate" name="date" placeholder="(dd-mm-yyyy)" value="{{ date_dmy($data->date) }}"  readonly>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="number" id="quantity" class="form-control bag_price" name="quantity" value="{{ $data->quantity }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select id="size" name="size" class="form-control">
                                ...
                                <option value="{{$size->name}}" @if($data->size == $size->name) {{ 'selected' }} @endif>{{$size->name}}</option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="col-md-8">
                            <select id="color" name="color" class="form-control">
                                ...
                                <?php foreach ($colors as $color) : ?>
                                    <option value="{{$color->name}}" @if($data->color == $color->name) {{ 'selected' }} @endif>{{$color->name}}</option>
                                <?php endforeach; ?>
                            </select>
                            <small class="text-danger">{{ $errors->first('size') }}</small>
                        </div>               
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select id="type" name="bag_type" class="form-control">
                                <option value="">Select Type</option>
                                <?php foreach ($types as $type) : ?>
                                    <option value="{{$type->name}}" @if($data->bag_type == $type->name) {{ 'selected' }} @endif>{{$type->name}}</option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                <input type="number" id="per_bag_price" class="form-control bag_price" name="per_bag_price" min="0" value="{{ $data->per_bag_price }}"  required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                <input type="number" id="total_price" class="form-control" name="total_price" min="0" value="{{ $data->total_price }}" required readonly>
                                <span class="input-group-addon">Tk</span>
                            </div>
