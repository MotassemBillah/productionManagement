...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Finish Stocks</h2>
    </div>
        ...
        <tbody>
            <tr>
                ...
                <td class="text-right wmd_30" style="">
                    <a href="{{ url ('finishstocks/opening') }}"><button class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Opening Stock</button></a>
                </td>
                <td class="text-right wmd_30" style="">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped tbl_thin">
                    <tbody>
                        ...
                        <?php
                        $stock_quantity = $product->sumStockQuantity($data->id);
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#search").click(function () {
            var _url = "{{ URL::to('finishstocks/search') }}";
            var _form = $("#frmSearch");
