...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Finish Category List</h2>
    </div>
        ...
        <tbody>
            <tr>
                ...
                <td class="text-right wmd_30" style="">
                    <a href="{{ url ('finishcategory/create') }}"><button class="btn btn-success btn-xs"><i class="fa fa-plus"></i> New</button></a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a class="btn btn-info btn-xs" href="finishcategory/{{ $data->id }}/edit"><i class="fa fa-edit"></i> Edit</a>
                    </td>
                    <?php if (has_user_access('product_category_delete')) : ?>
                        <td class="text-center">
                            <div class="checkbox">
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search").click(function () {
            var _url = "{{ URL::to('finishcategory/search') }}";
            var _form = $("#frmSearch");
        ...
        $("#Del_btn").click(function () {
            var _url = "{{ URL::to('finishcategory/delete') }}";
            var _form = $("#frmList");
