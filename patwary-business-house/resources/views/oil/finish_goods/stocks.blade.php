        ...
        <tbody>
            <tr>
                ...
                <td class="text-right wmd_30" style="">
                    <a href="{{ url ('finishgoods') }}"><button class="btn btn-success btn-sm"><i class="fa fa-plus"></i> New</button></a>
                </td>
                <td class="text-right wmd_30" style="">
...
<div class="order-list">
    ...
    <div id="print_area">
        {{ print_header("Finish Goods Stocks Information") }}
        <div id="ajax_content">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#search").click(function () {
            var _url = "{{ URL::to('finishgoods/stocks/search') }}";
            var _form = $("#frmSearch");
