...
<div class="col-md-12">
    <div class="panel panel-default">
        ...
        <div class="panel-body {{$pbg}}">
            {!! Form::open(['method' => 'PUT', 'url' => 'emptybag-stock/'.$data->id, 'id' => 'frmEmptyBags'  , 'class' => 'form-horizontal']) !!} 
            {{ csrf_field() }}
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" id="challan_no" class="form-control" name="challan_no" value="{{ $data->challan_no }}" required>
