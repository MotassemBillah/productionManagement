        ...
        <tbody>
            <tr>
                ...
                <td class="text-right wmd_30" style="">
                    <a href="{{ url ('rawcategory/create') }}"><button class="btn btn-success btn-xs"><i class="fa fa-plus"></i> New</button></a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a class="btn btn-info btn-xs" href="rawcategory/{{ $data->id }}/edit"><i class="fa fa-edit"></i> Edit</a>
                    </td>
                    <?php if (has_user_access('product_category_delete')) : ?>
                        <td class="text-center">
                            <div class="checkbox">
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search").click(function () {
            var _url = "{{ URL::to('rawcategory/search') }}";
            var _form = $("#frmSearch");
        ...
        $("#Del_btn").click(function () {
            var _url = "{{ URL::to('rawcategory/delete') }}";
            var _form = $("#frmList");
