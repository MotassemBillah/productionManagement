        ...
        <tbody>
            <tr>
                ...
                <td class="text-right wmd_30" style="">
                    <a href="{{ url ('flour/purchase-challan/create') }}"><button class="btn btn-success btn-sm"><i class="fa fa-plus"></i> New</button></a>
                    <a href="{{ url ('flour/raw-opening-stocks') }}"><button class="btn btn-warning btn-sm"><i class="fa fa-plus"></i> Opening Stocks</button></a>
                </td>
                <td class="text-right wmd_30" style="">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#search").click(function () {
            var _url = "{{ URL::to('flour/stocks/search') }}";
            var _form = $("#frmSearch");
