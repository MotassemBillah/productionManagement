        ...
        <tbody>
            <tr>
                <td class="wmd_70">
                    ...
                    <div class="input-group">
                        <div class="input-group-btn clearfix">
                            ...
                            <div class="col-md-2 col-sm-3 no_pad" style="width:20%;">
                            ...
                            <div class="col-md-2 col-sm-3 no_pad" style="width:20%;">
                                <select id="orderType" class="form-control" name="product">
                                    ...
                                    @foreach( $dataset as $pro)
                                    <option value="{{ $pro->id }}">{{ $pro->name }}</option>
                                    @endforeach
                                </select>
                            </div>   
                            <input type="text" name="search" id="q" style="width:182px;" class="form-control" placeholder="search product" size="30"/>
                ...
                <td class="text-right wmd_30" style="">
                    <a href="{{ url ('flour/production-stocks/create') }}"><button class="btn btn-success btn-sm"><i class="fa fa-plus"></i> New</button></a>
                    <a href="{{ url ('flour/finish-opening-stocks') }}"><button class="btn btn-warning btn-sm"><i class="fa fa-plus"></i> Opening Stocks</button></a>
                </td>
                <td class="text-right wmd_30" style="">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#search").click(function () {
            var _url = "{{ URL::to('flour/production-stocks/report/search') }}";
            var _form = $("#frmSearch");
