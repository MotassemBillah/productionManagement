        ...
        <tbody>
            <tr>
                <td class="wmd_70">
                    ...
                    <div class="input-group">
                        <div class="input-group-btn clearfix">
                            ...
                            <input type="text" style="width:182px;" name="search" style="width:182px;" id="q" class="form-control" placeholder="search order no" size="30"/>
                ...
                <td class="text-right" style="width:20%">
                    <a href="{{ url ('flour/production/create') }}"><button class="btn btn-success btn-xs"><i class="fa fa-plus"></i> New</button></a>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search").click(function () {
            var _url = "{{ URL::to('flour/production/search') }}";
            var _form = $("#frmSearch");
        ...
        $("#Del_btn").click(function () {
            var _url = "{{ URL::to('flour/production/delete') }}";
            var _form = $("#frmList");
