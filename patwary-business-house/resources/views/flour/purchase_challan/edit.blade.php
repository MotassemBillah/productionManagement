...
{!! Form::open(['method' => 'PUT', 'url' => 'flour/purchase-challan/'.$data->id, 'id'=>'frm_purchase', 'class' => 'form-horizontal']) !!}
{{ csrf_field() }}
...
<div class="row">
    ...
    <div class="col-md-5">
        ...
        <div class="mb_5 clearfix">
            ...
            <select class="col-md-7" id="productList" name="product">
        ...
        <div class="mb_5 clearfix">
            ...
            <input type="number" class="col-md-7" id="challan_weight" name="challan_weight" value="{{ $data->challan_weight }}" step="any">
        </div>
        <div class="mb_5 clearfix">
            <label for="scale_weight" class="col-md-5 text-right">Scale Weight:</label>
            <input type="number" class="col-md-7 qty" id="scale_weight" name="scale_weight" value="{{ $data->scale_weight }}" step="any">
        </div>
        <div class="mb_5 clearfix">
            <label for="bag_quantity" class="col-md-5 text-right">Bag Quantity:</label>
            <input type="number" class="col-md-7 qty" id="bag_quantity" name="bag_quantity" value="{{ $data->bag_quantity }}" step="any">
        </div>
        <div class="mb_5 clearfix">
            <label for="empty_bag_weight" class="col-md-5 text-right">Empty Bag Weight:</label>
            <input type="number" class="col-md-7" id="empty_bag_weight" name="empty_bag_weight" value="{{ $data->empty_bag_weight }}" step="any">
        </div>
        <div class="mb_5 clearfix">
        ...
        <div class="mb_5 clearfix">
            ...
            <input type="number" class="col-md-7 qty" id="per_kg_price" name="per_kg_price" value="{{ $data->per_kg_price }}" step="any">
        </div>
        <div class="mb_5 clearfix">
