...
{!! Form::open(['method' => 'PUT', 'url' => 'flour/sales-challan/'.$data->id, 'id'=>'frm_purchase', 'class' => 'form-horizontal']) !!}
{{ csrf_field() }}
    ...
    <table class="table table-bordered tbl_thin" id="check">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <input type="number" step="any" name="bag_quantity[{{ $product->id }}]" value="{{ $product->bag_quantity }}" class="form-control">
                </td>
                <td>
                    <input type="number" step="any" name="scale_weight[{{ $product->id }}]" value="{{ $product->scale_weight }}" class="form-control">
                </td>
            </tr>
            @endforeach
        </tbody>
