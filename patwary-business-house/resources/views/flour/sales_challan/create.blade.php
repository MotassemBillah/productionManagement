...
{!! Form::open(['method' => 'POST', 'url' => 'flour/sales-challan', 'id'=>'frm_purchase', 'class' => 'form-horizontal']) !!}
{{ csrf_field() }}
    ...
    <table class="table table-bordered tbl_thin" id="check">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <input type="number" step="any" name="bag_quantity[{{ $product->id }}]" class="form-control">
                </td>
                <td>
                    <input type="number" step="any" name="scale_weight[{{ $product->id }}]" class="form-control">
                </td>
            </tr>
            @endforeach
        </tbody>
