                ...
                <td class="wmd_70">
                    ...
                    <div class="input-group">
                        <div class="input-group-btn clearfix">
                            ...
                            <input type="text" name="search" style="width:182px;" id="q" class="form-control" placeholder="search product name" size="30"/>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search").click(function () {
            var _url = "{{ URL::to('flour/product/search') }}";
            var _form = $("#frmSearch");
        ...
        $("#Del_btn").click(function () {
            var _url = "{{ URL::to('flour/product/delete') }}";
            var _form = $("#frmList");
