...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Godown List</h2>
    </div>
        ...
        <tbody>
            <tr>
                <td class="wmd_70">
                    ...
                    <div class="input-group">
                        <div class="input-group-btn clearfix">
                            ...
                            <input type="text" name="search" id="q" style="width:182px;" class="form-control" placeholder="search godown" size="30"/>
                ...
                <td class="text-right wmd_30" style="">
                    <a href="{{ url ('flour/godowns/create') }}"><button class="btn btn-success btn-xs"><i class="fa fa-plus"></i> New</button></a>
                    <?php if (has_user_access('flour_godown_delete')) : ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search").click(function () {
            var _url = "{{ URL::to('flour/godowns/search') }}";
            var _form = $("#frmSearch");
        ...
        $("#Del_btn").click(function () {
            var _url = "{{ URL::to('flour/godowns/delete') }}";
            var _form = $("#frmList");
