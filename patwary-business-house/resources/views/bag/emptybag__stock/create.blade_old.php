            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select id="size" name="size" class="form-control">
                                ...
                                <?php foreach (emptyBagSize() as $key => $size) : ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select id="color" name="color" class="form-control">
                                ...
                                <?php foreach (emptyBagColor() as $key => $color) : ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select id="bag_type" name="bag_type" class="form-control">
                                ...
                                <?php foreach (emptyBagType() as $key => $type) : ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                <input type="number" id="per_bag_price" class="form-control bag_price" name="per_bag_price" min="0" required>
