...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Bag Type List</h2>
    </div>
        ...
        <tbody>
            <tr>
                ...
                <td class="text-right wmd_30" style="width:20%">
                    <a href="{{ url ('/bagtype/create') }}"><button class="btn btn-success btn-xs"><i class="fa fa-plus"></i> New</button></a>
...
<div id="print_area">
    <?php print_header("Bag Type Information"); ?>
    <div id="ajax_content">
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search").click(function () {
            var _url = "{{ URL::to('bagtype/search') }}";
            var _form = $("#frmSearch");
        ...
        $("#Del_btn").click(function () {
            var _url = "{{ URL::to('bagtype/delete') }}";
            var _form = $("#frmList");
