...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Update Raw Product</h2>
    </div>
...
<div class="col-md-12">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            {!! Form::open(['method' => 'PUT', 'url' => 'rawproduct/'.$data->id, 'class' => 'form-horizontal']) !!} 
            {{ csrf_field() }}
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <select name="raw_category_id" id="rawCategory" class="form-control" required="required">
                        ...
                        <option value="{{ $cat->id }}" @if($cat->id==$data->raw_category_id) {{ "selected" }} @endif >{{ $cat->name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input id="buy_price" type="number" class="form-control" step="any" min="0" name="buy_price" value="{{ $data->buy_price }}">
