                ...
                <td class="wmd_70">
                    ...
                    <div class="input-group">
                        <div class="input-group-btn clearfix">
                            ...
                            <input type="text" style="width:120px;" name="search" id="q" class="form-control" placeholder="search invoice" size="30"/>
...
<div class="order-list"> 
    ...
    <div id="print_area">
        <?php print_header("Purchase List"); ?>
        <div id="ajax_content">
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search").click(function () {
            var _url = "{{ URL::to('purchases/search') }}";
            var _form = $("#frmSearch");
        ...
        $("#Del_btn").click(function () {
            var _url = "{{ URL::to('purchases/delete') }}";
            var _form = $("#frmList");
