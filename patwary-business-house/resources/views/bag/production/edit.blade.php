...
{!! Form::open(['method' => 'PUT', 'url' => 'production/'.$data->id, 'id'=>'frm_purchase', 'class' => 'form-horizontal']) !!}
{{ csrf_field() }}
<div class="row">
...
<div class="table-responsive">
    <table class="table table-bordered" id="check">
        ...
        <td>
            <input type="number" step="any" id="per_price_{{ $product->id }}" value="{{ $product->per_qty_price }}" name="per_qty_price[{{ $product->id }}]" class="form-control qty" data-info="{{ $product->id }}" readonly>
        </td>
        <td>
