...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Create Opening Stock</h2>
    </div>
...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        ...
        <div class="mb_5 clearfix">
            ...
            <input type="text" class="col-md-7" id="invoice_no" name="invoice_no" value="<?php echo Purchase::get_opening_invoice(); ?>" readonly required>
        </div>
    </div>
</div>
    ...
    <table class="table table-bordered tbl_thin" id="check">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $product->unit }}</td>
                <td>
                    <input type="number" id="qty_{{ $product->id }}" name="quantity[{{ $product->id }}]" min="0" value="0" class="form-control qty" data-info="{{ $product->id }}">
                </td>
                <td>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on("submit", "#frm_purchase", function (e) {
            var _form = $(this);
            var _url = "{{ URL::to ('rawstocks/opening') }}";
