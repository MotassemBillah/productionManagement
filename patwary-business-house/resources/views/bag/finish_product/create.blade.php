...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Create Finish Product</h2>
    </div>
...
<div class="col-md-12">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            {!! Form::open(['method' => 'POST', 'url' => 'finishproduct', 'id' => 'frmProduct', 'class' => 'form-horizontal']) !!} 
            {{ csrf_field() }} 
            <div class="form-group">
                <label for="rawCategory"  class="col-md-4 control-label">Finish Category</label>
                <div class="col-md-6">
                    <select name="finish_category_id" id="rawCategory" class="form-control" required="required">
                        <option value="">Select Finish Category</option>
                        @foreach($category->all() as $pcat)
                        <option value="{{ $pcat->id }}">{{ $pcat->name }}</option>
                        @endforeach
                    </select>
                    <small class="text-danger">{{ $errors->first('finish_category_id') }}</small>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input id="buy_price" type="number" class="form-control" step="any" min="0" name="sale_price">
