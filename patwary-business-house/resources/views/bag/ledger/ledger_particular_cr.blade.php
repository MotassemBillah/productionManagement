...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Creditors Ledger Details</h2>
    </div>
...
<div id="print_area">
    {{ print_header("Creditors Ledger Details") }}
    <div id="ajax_content">
                        ...
                        <table class="table table-bordered tbl_thin" style="margin: 0;">
                            ...
                            <tr>
                                ...
                                if ($credit->purchase_id) :
                                    ...
                                    $items = $purchaseItem->where('purchase_id', $credit->purchase_id)->get();
                                    ?>
                                    <td style="padding:0;">
                                        <table class="table table-bordered">
                                            @foreach ( $items as $item )
                                            <?php
                                               $product_info = $rawproduct->find($item->raw_product_id);
                                            ?>
                                            <tr>
                                                <td>{{ $product_info->name }} {{ $item->quantity }} {{ $item->unitName($item->raw_product_id) }} = {{ $item->total_price }} Tk </td>
                                            </tr>
                                            @endforeach
                                        </table>
                                    </td>
