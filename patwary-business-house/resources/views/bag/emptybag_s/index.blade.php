        ...
        <tbody>
            <tr>
                ...
                <td class="text-right" style="width:32%">
                    <a class="btn btn-success btn-xs" href="{{ url('/emptybags/create/d') }}"><i class="fa fa-plus"></i>&nbsp;Purchase</a>
                    <a class="btn btn-warning btn-xs" href="{{ url('/emptybags/create/c') }}"><i class="fa fa-minus"></i>&nbsp;Sales</a>
