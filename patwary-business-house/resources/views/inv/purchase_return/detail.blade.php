...
@section('content')
<div id="print_area">
    <?php print_header("Purchase Return Detail", true, true); ?>
...
<div class="form-group">
    <div class="text-center clearfix">
        ...
        <?php if ($model->process_status == ORDER_PROCESSED): ?>
            <a class="btn btn-info xsw_50" href="{{ url ('inv/purchase-return/payment')}}/<?= $model->_key; ?>"><i class="fa fa-dollar"></i> Receive Payment</a>
        <?php endif; ?>
    </div>
</div>
@endsection