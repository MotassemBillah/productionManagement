...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title">Update Purchase Return Information</h3>
    </div>
    <div class="panel-body">
        {!! Form::open(['method' => 'PUT', 'url' => 'inv/purchase-return/'.$model->_key, 'class' => 'form-horizontal']) !!} 
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on("click", ".remove_item", function () {
            var _id = $(this).attr('data-info');
            var _url = "{{ URL::to('inv/purchase-return/delete_item') }}";
