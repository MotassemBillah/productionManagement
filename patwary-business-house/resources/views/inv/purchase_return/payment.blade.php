...
$sel_fsubh = !empty($model) ? $model->to_subhead_id : "";
$sel_fpart = !empty($model) ? $model->to_particular_id : "";
$sel_tsubh = !empty($payment) ? $payment->dr_subhead_id : "";
$sel_tpart = !empty($payment) ? $payment->dr_particular_id : "";
?>
<div class="row clearfix">
    <div class="col-md-6 col-sm-8 col-md-offset-3 col-sm-offset-2">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">Purchase Return Payment Form</h3>
            </div>
            <div class="panel-body">
                <form action="" method="POST" name="frmPayment">
                    {{ csrf_field() }}
                    <input type="hidden" name="purchase_return_id" value="{{$model->id}}">
                    <div class="row clearfix">
