...
<div class="well">
    <table width="100%">
        <tr>
            ...
            <td class="wmd_30 text-right clearfix" style="width: 12%;">
                <a class="btn btn-success btn-xs xsw_33" href="{{ url('/inv/purchase-return/cart') }}">{{ trans('words.view_cart') }}</a>
            </td>
        </tr>
    </table>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on("click", "#search", function () {
            var _url = "{{ URL::to('inv/purchase-return/search_product') }}";
            var _form = $("#frmSearch");
            $.ajax({
                url: _url,
                type: "post",
        ...
        $(document).on("click", ".add_to_cart", function () {
            ...
            var _url = "{{ URL::to('inv/purchase-return/add_cart_item') }}";
            var _formdata = {};
