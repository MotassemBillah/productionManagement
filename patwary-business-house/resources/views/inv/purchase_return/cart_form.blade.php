...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-4 col-sm-3 col-xs-10 no_pad">
        <ul class="text-right no_mrgn no_pad">
            ...
            <li><a href="{{ url('/inv/purchase-return') }}">Purchase Return</a> <i class="fa fa-angle-right"></i></li>
            <li>Form</li>
        </ul>                            
    </div>
</div>
...
@section('content')
{!! Form::open(['method' => 'POST', 'url' => 'inv/purchase-return', 'id' => 'frmCart', 'name' => 'frmCart']) !!} 
    ...
    <div class="col-md-10 col-sm-9">
        ...
        <div class="form-group">
            <div class="text-center clearfix">
                <a class="btn btn-info xsw_33" href="{{url('inv/purchase-return/create')}}">Add More Product</a>
                <a class="btn btn-warning xsw_33" href="{{url('inv/purchase-return/clear_cart')}}">Clear Cart</a>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on("click", ".remove_item", function () {
            var _id = $(this).attr('data-info');
            var _url = "{{ URL::to('inv/purchase-return/delete_cart_item') }}";
