    ...
    <table width="100%">
        <tr>
            <td class="wmd_70">
                ...
                <div class="input-group">
                    <div class="input-group-btn clearfix">
                        ...
                        <div style="width:17%;" class="col-md-2 col-sm-3 xsw_50 no_pad">
                            <div class="input-group">
            ...
            <td class="text-right wmd_30" style="width:25%">
                <a class="btn btn-success btn-xs xsw_25" href="{{ url ('inv/sale/create') }}"><i class="fa fa-plus"></i> New</a>
...
<div id="print_area">
    <?php print_header("Sales List", true, false); ?>
            ...
            <table class="table table-bordered tbl_thin" id="check">        
                ...
                <tr onmouseover="change_color(this, true)" onmouseout="change_color(this, false)">
                    ...
                    <td class="text-center hip">
                        ...
                        <a class="btn btn-info btn-xs" href="sale/{{$data->_key}}/edit">Edit</a>
                        <a class="btn btn-warning btn-xs btn_process" href="javascript:void(0)" data-info="{{$data->_key}}">Process</a>
                        @endif
                        <a class="btn btn-primary btn-xs" href="sale/detail/{{$data->_key}}">View</a>
                    </td>
                    <td class="text-center hip">
                        <?php if (has_user_access('inv_sales_delete')) : ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $(document).on("click", "#search", function () {
            var _url = "{{ URL::to('inv/sale/search') }}";
            var _form = $("#frmSearch");
        ...
        $(document).on("click", ".btn_process", function () {
            var _url = "{{ URL::to('inv/sale/process') }}";
            var _formdata = {};
        ...
        $(document).on("click", "#btn_reset", function () {
            var _url = "{{ URL::to('inv/sale/reset') }}";
            var _form = $("#frmList");
        ...
        $(document).on("click", "#Del_btn", function () {
            var _url = "{{ URL::to('inv/sale/delete') }}";
            var _form = $("#frmList");
            var _rc = confirm("Are you sure about this action? This cannot be undone!");
