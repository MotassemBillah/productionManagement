...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-4 col-sm-3 col-xs-10 no_pad">
        <ul class="text-right no_mrgn no_pad">
            ...
            <li><a href="{{ url('/inv/sale') }}">Sale</a> <i class="fa fa-angle-right"></i></li>
            <li>Detail</li>
        </ul>                            
    </div>
</div>
...
@section('content')
<div id="print_area">
    <?php print_header("Sale Detail", true, true); ?>

    <div class="row clearfix">
        <div class="col-md-3 col-sm-4 col-xs-6 mb_10 mp_50">
            <strong>Invoice Date : </strong>{{ date_dmy($model->invoice_date) }}<br>
            <strong>Invoice No : </strong>{{ $model->invoice_no }}<br>
            <strong>Challan No : </strong>{{ $model->challan_no }}<br>
        </div>
    ...
    <div class="table-responsive">
        <table class="table table-bordered tbl_thin">
            ...
            foreach ($model->items as $item):
                ...
                ?>
                <tr>
                    <td class="text-center"><?= $_counter; ?></td>
            ...
            <tr class="bg-info">
                ...
                <th class="text-center" style="width: 100px;"><?= array_sum($_sumQty); ?></th>
                <th class="text-center" style="width: 100px;"></th>
                <th class="text-right" style="width: 130px;"><?= array_sum($_sumAmount); ?></th>
            </tr>
        </table>
    </div>
    @endif
            ...
            <div class="mb_10">
                <table class="table table-bordered tbl_thin">
                    <tr>
                        ...
                        <td class="text-right" style="width: 130px"><?= $model->invoice_amount; ?></td>
                    </tr>
                    <tr>
                        <th>Other Amount</th>
                        <td class="text-right" style="width: 130px"><?= ($model->transport_cost + $model->labor_cost); ?></td>
                    </tr>
                    <tr>
                        <th>Total Amount</th>
                        <td class="text-right" style="width: 130px"><?= $model->total_amount; ?></td>
                    </tr>
                    <tr>
                        <th>Discount Amount</th>
                        <td class="text-right" style="width: 130px"><?= $model->discount_amount; ?></td>
                    </tr>
                    <tr>
                        <th>Payable</th>
                        <td class="text-right" style="width: 130px"><?= $model->net_amount; ?></td>
                    </tr>
                    <tr>
                        <th>Paid</th>
                        <td class="text-right" style="width: 130px"><?= $model->paid_amount; ?></td>
                    </tr>
                    <tr>
                        <th>Current Due</th>
                        <td class="text-right" style="width: 100px"><?= $model->due_amount; ?></td>
                    </tr>
                    <tr>
                        <th>Previous Due</th>
                        <td class="text-right" style="width: 100px">
                            <?= ($particular_net_balance < 0) ? ($particular_net_balance + $model->due_amount) : ($particular_net_balance - $model->due_amount); ?>
                        </td>
                    </tr>
                    <tr>
                        <th>Net Balance</th>
                        <td class="text-right" style="width: 100px"><?= $particular_net_balance; ?></td>
                    </tr>
                </table>
            </div>
        </div>
...
<div class="form-group clearfix">
    <div class="text-center">
        ...
        <?php if ($model->process_status == ORDER_PROCESSED): ?>
            <a class="btn btn-info xsw_50" href="{{ url ('inv/sale/payment')}}/<?= $model->_key; ?>"><i class="fa fa-dollar"></i> Receive Payment</a>
        <?php endif; ?>
    </div>
</div>
@endsection