...
@section('content')
{!! Form::open(['method' => 'POST', 'url' => 'inv/sale', 'id' => 'frmCart', 'name' => 'frmCart']) !!} 
    ...
    <div class="col-md-10 col-sm-9">
            ...
            <table class="table table-bordered table-hover tbl_thin" id="check">
                ...
                foreach ($dataset as $data):
                    ...
                    <tr id="row_{{ $data->id }}">
                        ...
                        <td class="text-center">{{ !empty($data->product) ? $data->unit : "" }}</td>
                        <td>{{ !empty($data->product) ? $data->size : "" }}</td>
                        <td class="text-center">{{ !empty($data->product) ? $data->weight : "" }}</td>
                        <td class="text-center">
        ...
        <div class="form-group">
            <div class="text-center clearfix">
                <a class="btn btn-info xsw_33" href="{{url('inv/sale/create')}}">Add More Product</a>
                <a class="btn btn-warning xsw_33" href="{{url('inv/sale/clear_cart')}}">Clear Cart</a>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on("click", ".remove_item", function () {
            var _id = $(this).attr('data-info');
            var _url = "{{ URL::to('inv/sale/delete_cart_item') }}";
