            ...
            <td class="wmd_70 clearfix">
                ...
                <div class="input-group">
                    <div class="input-group-btn clearfix">
                        ...
                        <div style="width:12%;" class="col-md-2 xsw_70 col-sm-3 no_pad">
            ...
            <table class="table table-bordered tbl_thin" id="check">
                ...
                <tr onmouseover="change_color(this, true)" onmouseout="change_color(this, false)">
                    ...
                    <td class="text-center hip">
                        ...
                        <a class="btn btn-info btn-xs" href="purchase/{{$data->_key}}/edit">Edit</a>
                        <a class="btn btn-warning btn-xs btn_process" href="javascript:void(0)" data-info="{{$data->_key}}">Process</a>
                        @endif
                        <a class="btn btn-primary btn-xs" href="purchase/detail/{{$data->_key}}">View</a>
                    </td>
                    <td class="text-center hip">
                        <?php if (has_user_access('inv_purchase_delete')) : ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $(document).on("click", "#search", function () {
            var _url = "{{ URL::to('inv/purchase/search') }}";
            var _form = $("#frmSearch");
        ...
        $(document).on("click", ".btn_process", function () {
            var _url = "{{ URL::to('inv/purchase/process') }}";
            var _formdata = {};
        ...
        $(document).on("click", "#btn_reset", function () {
            var _url = "{{ URL::to('inv/purchase/reset') }}";
            var _form = $("#frmList");
        ...
        $(document).on("click", "#Del_btn", function () {
            var _url = "{{ URL::to('inv/purchase/delete') }}";
            var _form = $("#frmList");
            var _rc = confirm("Are you sure about this action? This cannot be undone!");
