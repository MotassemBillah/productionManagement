...
@section('content')
{!! Form::open(['method' => 'POST', 'url' => 'inv/purchase', 'id' => 'frmCart', 'name' => 'frmCart']) !!} 
    ...
    <div class="col-md-10 col-sm-9">
        ...
        <div class="form-group">
            <div class="text-center clearfix">
                <a class="btn btn-info xsw_33" href="{{url('inv/purchase/create')}}">Add More Product</a>
                <a class="btn btn-warning xsw_33" href="{{url('inv/purchase/clear_cart')}}">Clear Cart</a>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on("click", ".remove_item", function () {
            var _id = $(this).attr('data-info');
            var _url = "{{ URL::to('inv/purchase/delete_cart_item') }}";
