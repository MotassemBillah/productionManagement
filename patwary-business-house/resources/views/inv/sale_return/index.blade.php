    ...
    <table width="100%">
        <tr>
            ...
            <td class="text-right wmd_30 clearfix" style="width:25%">
                <a class="btn btn-success btn-xs xsw_25" href="{{ url ('inv/sale-return/create') }}"><i class="fa fa-plus"></i> New</a>
...
<script type="text/javascript">
    $(document).ready(function () {
        $(document).on("click", "#search", function () {
            var _url = "{{ URL::to('inv/sale-return/search') }}";
            var _form = $("#frmSearch");
        ...
        $(document).on("click", ".btn_process", function () {
            var _url = "{{ URL::to('inv/sale-return/process') }}";
            var _formdata = {};
        ...
        $(document).on("click", "#btn_reset", function () {
            var _url = "{{ URL::to('inv/sale-return/reset') }}";
            var _form = $("#frmList");
        ...
        $(document).on("click", "#Del_btn", function () {
            var _url = "{{ URL::to('inv/sale-return/delete') }}";
            var _form = $("#frmList");
            var _rc = confirm("Are you sure about this action? This cannot be undone!");
