...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        {!! Form::open(['method' => 'PUT', 'url' => 'inv/product/'.$data->id, 'class' => 'form-horizontal']) !!} 
        {{ csrf_field() }}
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <select class="form-control" id="unit" name="unit" required>
                    ...
                    <option value="{{ $_ukey }}" <?php if ($_ukey == $data->unit) echo ' selected'; ?>>{{ $_uval }}</option>
                    @endforeach
                </select>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <select class="form-control" id="printed" name="printed">
                    ...
                    <option value="{{ $printed_key }}" <?php if ($printed_key == $data->printed) echo ' selected'; ?>>{{ $printed_val }}</option>
                    @endforeach
                </select>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <select class="form-control" id="laminated" name="laminated">
                    ...
                    <option value="{{ $laminated_key }}" <?php if ($laminated_key == $data->laminated) echo ' selected'; ?>>{{ $laminated_val }}</option>
                    @endforeach
                </select>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <select class="form-control" id="liner" name="liner">
                    ...
                    <option value="{{ $liner_key }}" <?php if ($liner_key == $data->liner) echo ' selected'; ?>>{{ $liner_val }}</option>
                    @endforeach
                </select>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="number" class="form-control" id="buy_price" name="buy_price" value="{{ $data->buy_price }}" min="0" step="any">
