        ...
        <tbody>
            <tr>
                ...
                <td class="text-right" style="width:20%">
                    <a href="{{ url ('rice/production/create') }}"><button class="btn btn-success btn-xs"><i class="fa fa-plus"></i> New</button></a>
                    <?php if (has_user_access('rice_production_delete')) : ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center hip">
                                <?php if ($status == 'Pending'): ?>
                                    ...
                                    <?php if (has_user_access('rice_production_confirm')) : ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search").click(function () {
            var _url = "{{ URL::to('rice/production/search') }}";
            var _form = $("#frmSearch");
        ...
        $("#Del_btn").click(function () {
            var _url = "{{ URL::to('rice/production/delete') }}";
            var _form = $("#frmList");
