    ...
    <div class="panel-body">
        ...
        <div class="col-md-6" style="margin-bottom:30px;">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" value="<?php echo App\Models\Rice\ProductionStock::get_production_stocks_invoice(); ?>" class="form-control" name="production_stocks_no" readonly>
                    <small class="text-danger">{{ $errors->first('production_stocks_no') }}</small>
                </div>
            </div>
        </div>
        <table class="table table-bordered table-hover table-striped tbl_thin">
            <tbody>
                <tr class="bg_gray">
                    <th>Product</th>
                    <th>Bag Weight(Kg)</th>
