        ...
        <tbody>
            <tr>
                <td class="wmd_70">
                    ...
                    <div class="input-group">
                        <div class="input-group-btn clearfix">
                            ...
                            <input type="text" name="search" id="q" class="form-control" placeholder="search godown" size="30"/>
                ...
                <td class="text-right wmd_30" style="">
                    <a href="{{ url ('rice/godowns/create') }}"><button class="btn btn-success btn-xs"><i class="fa fa-plus"></i> New</button></a>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search").click(function () {
            var _url = "{{ URL::to('rice/godowns/search') }}";
            var _form = $("#frmSearch");
        ...
        $("#Del_btn").click(function () {
            var _url = "{{ URL::to('rice/godowns/delete') }}";
            var _form = $("#frmList");
