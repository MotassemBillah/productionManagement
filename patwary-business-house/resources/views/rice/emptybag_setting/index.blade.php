        ...
        <tbody>
            <tr>
                ...
                <td class="text-right wmd_30" style="">
                    <a href="{{ url ('rice/emptybag-setting/create') }}"><button class="btn btn-success btn-xs"><i class="fa fa-plus"></i> New</button></a>
                    <?php if (has_user_access('rice_emptybag_setting_delete')) : ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search").click(function () {
            var _url = "{{ URL::to('rice/emptybag-setting/search') }}";
            var _form = $("#frmSearch");
        ...
        $("#Del_btn").click(function () {
            var _url = "{{ URL::to('rice/emptybag-setting/delete') }}";
            var _form = $("#frmList");
