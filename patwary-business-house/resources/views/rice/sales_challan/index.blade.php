        ...
        <tbody>
            <tr>
                ...
                <td class="text-right" style="width:20%">
                    <a href="{{ url ('rice/sales-challan/create') }}"><button class="btn btn-success btn-xs"><i class="fa fa-plus"></i> New</button></a>
                ...
                <table class="table table-bordered" id="check">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">{{ $data->items->sum('net_weight') }}</td>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search").click(function () {
            var _url = "{{ URL::to('rice/sales-challan/search') }}";
            var _form = $("#frmSearch");
        ...
        $("#Del_btn").click(function () {
            var _url = "{{ URL::to('rice/sales-challan/delete') }}";
            var _form = $("#frmList");
