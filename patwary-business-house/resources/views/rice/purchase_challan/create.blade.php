...
{!! Form::open(['method' => 'POST', 'url' => 'rice/purchase-challan', 'id'=>'frm_purchase', 'class' => 'form-horizontal']) !!}
{{ csrf_field() }}
...
<div class="row">
    ...
    <div class="col-md-5">
        <div class="mb_5 clearfix">
            ...
            <input type="number" class="col-md-7 qty" id="challan_weight" name="challan_weight" step="any">
        </div>
        <div class="mb_5 clearfix">
            ...
            <small class="text-danger">{{ $errors->first('scale_weight') }}</small>
        </div>
        <div class="mb_5 clearfix">
            <label for="main_weight" class="col-md-5 text-right">Main Weight:</label>
            <input type="number" class="col-md-7 qty" id="main_weight" name="main_weight" step="any" readonly>
        ...
        <div class="mb_5 clearfix">
            ...
            <input type="number" class="col-md-7" id="empty_bag_total_weight" name="empty_bag_weight" step="any" readonly>
        </div>
        <div class="mb_5 clearfix">
            <label for="dhorla" class="col-md-5 text-right">Dhorla:</label>
            <input type="number" class="col-md-7 qty" id="dhorla" name="dhorla" step="any">
        </div>
        <div class="mb_5 clearfix">
        ...
        <div class="mb_5 clearfix">
            ...
            <input type="number" class="col-md-7" id="net_mon" name="net_mon" step="any" readonly>
            <small class="text-danger">{{ $errors->first('net_mon') }}</small>
        </div>
        <div class="mb_5 clearfix">
            <label for="per_mon_price" class="col-md-5 text-right">Per Mon Price:</label>
            <input type="number" class="col-md-7 qty" id="per_mon_price" name="per_mon_price" step="any">
