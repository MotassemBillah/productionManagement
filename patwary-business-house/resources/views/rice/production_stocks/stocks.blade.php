        ...
        <tbody>
            <tr>
                ...
                <td class="text-right wmd_30" style="">
                    <a href="{{ url ('rice/production-stocks/create') }}"><button class="btn btn-success btn-sm"><i class="fa fa-plus"></i> New</button></a>
                    <a href="{{ url ('rice/finish-opening-stocks') }}"><button class="btn btn-warning btn-sm"><i class="fa fa-plus"></i> Opening Stocks</button></a>
                </td>
                <td class="text-right wmd_30" style="">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#search").click(function () {
            var _url = "{{ URL::to('rice/production-stocks/report/search') }}";
            var _form = $("#frmSearch");
