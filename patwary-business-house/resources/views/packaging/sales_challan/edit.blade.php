...
{!! Form::open(['method' => 'PUT', 'url' => 'packaging/sales-challan/'.$data->id, 'id'=>'frm_sales', 'class' => 'form-horizontal']) !!}
{{ csrf_field() }}
    ...
    <table class="table table-bordered tbl_thin" id="check">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <input type="number" step="any" id="qty_{{ $product->id }}" name="bag_quantity[{{ $product->id }}]" value="{{ $product->quantity }}" class="form-control qty" data-info="{{ $product->id }}">
                </td>
                <td>
                    <input type="number" step="any" id="per_price_{{ $product->id }}" name="per_qty_price[{{ $product->id }}]" value="{{ $product->per_qty_price }}" min="0" class="form-control qty" data-info="{{ $product->id }}">
                </td>
                <td>
...
<div class="col-md-12" style="margin-top: 20px; ">
    <div class="form-group">
        <div class="text-center">
            ...
            <button type="submit" class="btn btn-primary" id="btnSales">Update</button>
        </div>
    </div>
</div>
