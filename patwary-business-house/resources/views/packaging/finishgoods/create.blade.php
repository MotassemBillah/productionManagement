...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-3 col-sm-3 col-xs-4 cxs_12 no_pad">
        <ul class="text-right no_mrgn">
            <li><a href="{{ url('/home') }}"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a> <span class="divider">/</span></li><li><span><i class="fa fa-file"></i> Finish Goods</span></li>
        </ul>
    </div>
</div>
...
<div class="row">
    <div class="col-md-6 col-md-offset-2">
        ...
        <div class="mb_5 clearfix">
            <label for="invoice_no" class="col-md-5 text-right">Order No:</label>
            <input type="text" class="col-md-7" id="invoice_no" name="invoice_no" value="<?php echo SalesChallan::get_finishgoods_invoice(); ?>" readonly required>
        </div>
    </div>
</div>
...
<div class="col-md-12">
    <div class="form-group">
        <div class="text-center">
            ...
            <button type="submit" class="btn btn-primary" id="btnFinish Goods">Save</button>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on("submit", "#frm_purchase", function (e) {
            var _form = $(this);
            var _url = "{{ URL::to ('packaging/finishgoods') }}";
            $.post(_url, _form.serialize(), function (res) {
                if (res.success === true) {
                    _form[0].reset();
                    redirectTo('{{ url('packaging/finishgoods') }}')
