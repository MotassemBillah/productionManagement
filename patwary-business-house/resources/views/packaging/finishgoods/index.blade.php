        ...
        <tbody>
            <tr>
                ...
                <td class="text-right" style="width:20%">
                    <a href="{{ url ('packaging/finishgoods/create') }}"><button class="btn btn-success btn-xs"><i class="fa fa-plus"></i> New</button></a>
                    <?php if (has_user_access('packaging_finishgoods_delete')) : ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center hip">
                                <?php if ($process_status == 'Pending'): ?>
                                    ...
                                    <?php if (has_user_access('packaging_finishgoods_confirm')) : ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search").click(function () {
            var _url = "{{ URL::to('packaging/finishgoods/search') }}";
            var _form = $("#frmSearch");
        ...
        $("#Del_btn").click(function () {
            var _url = "{{ URL::to('packaging/finishgoods/delete') }}";
            var _form = $("#frmList");
