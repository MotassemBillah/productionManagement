...
{!! Form::open(['method' => 'PUT', 'url' => 'packaging/production/'.$data->id, 'id'=>'frm_purchase', 'class' => 'form-horizontal']) !!}
{{ csrf_field() }}
<div class="row">
    <div class="col-md-6 col-md-offset-2">
        ...
        <div class="mb_5 clearfix">
            <label class="col-md-5 text-right">SR No:</label>
        ...
        <div class="mb_5 clearfix">
            ...
            <select class="col-md-7" name="production_type" required>
                ...
                <option value="{{ $val }}" @if($val == $data->production_type) {{ 'selected' }} @endif>{{ $val }}</option>
                @endforeach
            </select>
        </div>
    </div>
