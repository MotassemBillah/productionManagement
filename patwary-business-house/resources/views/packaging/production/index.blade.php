...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Production List</h2>
    </div>
    <div class="col-md-3 col-sm-3 col-xs-4 cxs_12 no_pad">
        <ul class="text-right no_mrgn">
            <li><a href="{{ url('/home') }}"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a> <span class="divider">></span></li><li>Production</span></li>
        </ul>                            
    </div>
</div>
<div class="well">
        ...
        <tbody>
            <tr>
                ...
                <td class="text-right" style="width:20%">
                    <a href="{{ url ('packaging/production/create') }}"><button class="btn btn-success btn-xs"><i class="fa fa-plus"></i> New</button></a>
                    <?php if (has_user_access('packaging_production_delete')) : ?>
...
<div class="order-list"> 
    ...
    <div id="print_area">
        <?php print_header("Production List"); ?>
        <div id="ajax_content">
                        ...
                        <tr>
                            ...
                            <td class="text-center hip">
                                <?php if ($process_status == 'Pending'): ?>
                                    ...
                                    <?php if (has_user_access('packaging_production_confirm')) : ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search").click(function () {
            var _url = "{{ URL::to('packaging/production/search') }}";
            var _form = $("#frmSearch");
        ...
        $("#Del_btn").click(function () {
            var _url = "{{ URL::to('packaging/production/delete') }}";
            var _form = $("#frmList");
