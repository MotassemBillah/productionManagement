        ...
        <tbody>
            <tr>
                ...
                <td class="text-right wmd_30" style="">
                    <a href="{{ url ('packaging/rawstocks/opening') }}"><button class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Opening Stock</button></a>
                </td>
                <td class="text-right wmd_30" style="">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#search").click(function () {
            var _url = "{{ URL::to('packaging/rawstocks/search') }}";
            var _form = $("#frmSearch");
