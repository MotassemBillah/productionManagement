        ...
        <tbody>
            <tr>
                ...
                <td class="text-right" style="width:20%">
                    <a href="{{ url ('packaging/purchase-challan/create') }}"><button class="btn btn-success btn-xs"><i class="fa fa-plus"></i> New</button></a>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search").click(function () {
            var _url = "{{ URL::to('packaging/purchase-challan/search') }}";
            var _form = $("#frmSearch");
        ...
        $("#Del_btn").click(function () {
            var _url = "{{ URL::to('packaging/purchase-challan/delete') }}";
            var _form = $("#frmList");
