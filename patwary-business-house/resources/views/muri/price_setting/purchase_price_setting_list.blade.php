...
<?php 
    ...
    $price_setting=PriceSetting::where('type','=','purchase_price')->get();
 ?>
    <div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
        ...
        <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
            <h2 class="page-title">Purchase Price Setting List</h2>
        </div>
        <div class="col-md-3 col-sm-3 col-xs-4 cxs_12 no_pad">
            <ul class="text-right no_mrgn">
                <li><a href="{{ url('/home') }}"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a> <span class="divider">/</span></li><li><span><i class="fa fa-file"></i> Purchase Price</span></li>
            </ul>                            
        </div>
    </div>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="text-right wmd_30" style="">
                        <a href="{{ url ('/new-purchase-price-setting') }}"><button class="btn btn-success btn-sm"><i class="fa fa-plus"></i> New</button></a>
                    </td>
                </tr>
            </tbody>
        </table>
                   ...
                   ?> 
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-info btn-xs" href="edit-purchase-price-settiing/{{ $product->id }}"><i class="fa fa-edit"></i> Edit</a>
                            <a class="btn btn-danger btn-xs" href="purchase-price/delete/{{$product->id }}" onClick="return confirm('Are you sure about this action? This cannot be undone!');"><i class="fa fa-trash-o"></i> Delete</a>
                        </td>
                        <?php $sl++;  ?>
                    </tr>
