...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Update After Production</h2>
    </div>
...
<div class="col-md-12">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            {!! Form::open(['method' => 'PUT', 'url' => 'after-production/'.$data->id, 'class' => 'form-horizontal']) !!} 
            {{ csrf_field() }} 
            ...
            <div class="form-group">
                <label class="col-md-4 control-label">After Product Name</label>
                <div class="col-md-6">
                    <input type="text" class="form-control" name="after_product_name" value="{{ $data->name }}" required>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">Bag Weight</label>
                <div class="col-md-6">
                    <input type="number" min="0" class="form-control" value="{{ $data->weight }}" name="bag_weight"> 
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">Sale Price</label>
                <div class="col-md-6">
                    <input type="number" min="0" class="form-control" value="{{ $data->sale_price }}" name="sale_price"> 
                </div>
            </div>
            <div class="form-group">
