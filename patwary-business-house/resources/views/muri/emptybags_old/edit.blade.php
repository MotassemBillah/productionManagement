...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Update Empty Bag ({{ $title }})</h2>
    </div>
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                <input type="text" id="datepicker" class="form-control pickdate" name="date" value="{{ date_dmy($data->date) }}" readonly>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select id="head" class="form-control" name="subhead" required>
                                ...
                                <option value="{{$head->id}}" @if($data->subhead_id == $head->id) {{ 'selected' }} @endif>{{$head->name}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select id="subhead" class="form-control" name="particular">
                                <option value="">Select Sub Head</option>
                                @foreach($particular->where('subhead_id',$data->subhead_id)->get() as $pt)
                                <option value="{{$pt->id}}" @if($data->particular_id == $pt->id) {{ 'selected' }} @endif>{{$pt->name}}</option>
                                @endforeach
                            </select>
                        </div> 
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                <input type="number" id="quantity" class="form-control" name="quantity" min="0" value="{{ $data->quantity }}" required>
