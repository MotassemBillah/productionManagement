...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="mb_5 clearfix">
            ...
            <input type="number" class="col-md-7" id="wpq" name="wpq" min="0" step="any" onkeyup="weight_measure()" required>
        </div>
        <div class="mb_5 clearfix">
            <label class="col-md-5 text-right">Net Weight:</label>
            <input type="number" class="col-md-7" id="net_weight" name="total_net_weight" min="0" onkeyup="net_weight_measure()" required>
        </div>
        <div class="mb_5 clearfix">
...
<script type="text/javascript">
    ...
    function net_weight_measure() {
        ...
        netWpq = netWeight/quantity;
        mon = kgToMon(netWeight, mon);
        document.getElementById('wpq').value = netWpq.toFixed(2);
        document.getElementById('mon').value = mon;
    }
