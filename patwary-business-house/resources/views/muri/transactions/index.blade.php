        ...
        <tbody>
            <tr>
                        ...
                        <div class="input-group-btn clearfix">
                            ...
                            <div style="width:16%;" class="col-md-2 col-sm-3 no_pad">
                                <select id="sortBy" class="form-control" name="search_by">
                                    ...
                                    <option value="Due Voucher">Due Voucher</option>                 
                                    <option value="Purchase Voucher">Purchase Voucher</option>                 
                                    <option value="Sales Voucher">Sales Voucher</option>                 
                                    <option value="Paddy Sales Voucher">Paddy Sales Voucher</option>                 
                                </select>
                            </div> 
                ...
                <td class="text-right" style="width:32%">
                    ...
                    <a class="btn btn-info btn-xs" href="{{ url('/transactions/create/due') }}"><i class="fa fa-plus"></i>&nbsp;Due</a>
