...
class LedgerController extends HomeController {
    ...
    public function particular_transaction($id) {
        ...
        if ($head == HEAD_CREDITORS) {
            return view('Admin.ledger.ledger_particular_cr', compact('particular', 'rawproduct', 'all_debit', 'all_credit'));
        } elseif ($head == HEAD_DEBTORS) {
            return view('Admin.ledger.ledger_particular_dr', compact('particular', 'finishproduct', 'product', 'all_debit', 'all_credit'));
        } else {
    ...
    public function particular_transaction_search(Request $r) {
        ...
        $head = $particular->head->id;
        if ($head == HEAD_CREDITORS) {
            return view('Admin.ledger.ledger_particular_cr_search', compact('particular', 'rawproduct', 'all_debit', 'all_credit'));
        } elseif ($head == HEAD_DEBTORS) {
            return view('Admin.ledger.ledger_particular_dr_search', compact('particular', 'finishproduct', 'all_debit', 'all_credit'));
        } else {
    ...
    public function trial_balance() {
        ...
        $tmodel = new Transaction();
        return view('Admin.ledger.trial_balance', compact('dataset', 'tmodel'));
    }
