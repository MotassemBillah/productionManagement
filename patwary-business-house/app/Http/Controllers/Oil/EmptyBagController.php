...
class EmptyBagController extends HomeController {
    ...
    public function index() {
        ...
        return view('Admin.emptybags.index', compact('dataset', 'subhead'));
    }
    ...
    public function create($tp) {
        ...
        $colors = BagColor::get();
        $types = BagType::get();
        return view('Admin.emptybags.create', compact('tp', 'heads', 'sizes', 'colors', 'types'));
    }
    ...
    public function edit($id) {
        ...
        $colors = BagColor::get();
        $types = BagType::get();
        return view('Admin.emptybags.edit', compact('data', 'heads', 'particular', 'sizes', 'colors', 'types'));
    }

    public function show($id) {
        $data = EmptyBag::find($id);
        $subhead = new SubHead();
        return view('Admin.emptybags.view', compact('data', 'subhead'));
    }
    ...
    public function search(Request $r) {
        ...
        $subhead = new SubHead();
        return view('Admin.emptybags._list', compact('dataset', 'subhead'));
    }
