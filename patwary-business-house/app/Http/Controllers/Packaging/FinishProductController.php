...
class FinishProductController extends HomeController {
    ...
    public function index() {
        ...
        return view('packaging.finish_products.index', compact('dataset', 'categories'));
    }

    public function create() {
        adminMsg();
        $category = new Category();
        return view('packaging.products.create', compact('category'));
    }
    ...
    public function edit($id) {
        ...
        return view('packaging.products.edit', compact('data', 'category'));
    }
    ...
    public function search(Request $r) {
        ...
        $dataset = $query->paginate($this->getSettings()->pagesize);
        $categories = Category::where([['is_deleted', 0], ['business_type_id', PACKAGING]])->get();
        return view('packaging.finish_products._list', compact('dataset', 'categories'));
    }
