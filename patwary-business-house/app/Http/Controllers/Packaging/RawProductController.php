...
class RawProductController extends HomeController {
    ...
    public function index() {
        ...
        return view('packaging.raw_products.index', compact('dataset', 'categories'));
    }

    public function create() {
        adminMsg();
        $category = new Category();
        return view('packaging.raw_products.create', compact('category'));
    }
    ...
    public function search(Request $r) {
        ...
        return view('packaging.raw_products._list', compact('dataset', 'categories'));
    }
