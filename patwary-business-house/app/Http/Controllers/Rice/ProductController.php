...
class ProductController extends HomeController {
    ...
    public function index() {
        ...
        return view('rice.products.index', compact('dataset', 'categories'));
    }

    public function create() {
        adminMsg();
        $category = new Category();
        return view('rice.products.create', compact('category'));
    }
    ...
    public function edit($id) {
        ...
        return view('rice.products.edit', compact('data', 'category'));
    }
    ...
    public function search(Request $r) {
        ...
        return view('rice.products._list', compact('dataset', 'categories'));
    }
