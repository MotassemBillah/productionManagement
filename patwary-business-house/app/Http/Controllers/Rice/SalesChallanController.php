...
use App\Models\Rice\SalesChallan;
use App\Models\Rice\SalesChallanItem;
use App\Models\SubHead;
use App\Models\Particular;
use App\Models\Transaction;
use App\Models\Rice\Drawer;
use App\Models\Rice\ProductionOrderItem;
...
class SalesChallanController extends HomeController {
    ...
    public function index() {
        ...
        return view('rice.sales_challan.index', compact('dataset', 'insLIst'));
    }

    public function details() {
        $model = new SalesChallanItem();
        $query = is_Admin() ? $model : $model->where('institute_id', institute_id());
        $dataset = $query->orderBy('date', 'DESC')->paginate($this->getSettings()->pagesize);
        return view('rice.sales_challan.items', compact('dataset'));
    }
    ...
    public function create() {
        ...
        return view('rice.sales_challan.create', compact('products', 'subheads', 'category'));
    }
    ...
    public function store(Request $r) {
        ...
        try {
            ...
            foreach ($_POST['product'] as $key => $value) {
                ...
                $modelItem->track_weight = $_POST['track_weight'][$value];
                $modelItem->net_weight = $_POST['net_weight'][$value];
                if (!$modelItem->save()) {
                ...
                $modelStock->weight = $modelItem->net_weight;
            ...
            DB::commit();
            return redirect('/rice/sales-challan')->with('success', 'New Record Created Successfully.');
        } catch (Exception $e) {
            DB::rollback();
    ...
    public function show($id) {
        ...
        $category = new Category();
        return view('rice.sales_challan.details', compact('data', 'category', 'products', 'drawer'));
    }
    ...
    public function edit($id) {
        ...
        return view('rice.sales_challan.edit', compact('data', 'categories', 'products', 'subheads', 'particulars'));
    }
    ...
    public function update(Request $r, $id) {
        ...
        try {
            ...
            DB::commit();
            return redirect('rice/sales-challan')->with('success', 'Sale Challan Updated Successfully.');
        } catch (Exception $e) {
            DB::rollback();
            return redirect()->back()->with('danger', $e->getMessage());
        }
    ...
    public function search(Request $r) {
        ...
        return view('rice.sales_challan._list', compact('dataset'));
    }
    ...
    public function search_items(Request $r) {
        ...
        $dataset = $query->orderBy('date', 'DESC')->paginate($item_count);
        return view('rice.sales_challan.item_list', compact('dataset'));
    }
