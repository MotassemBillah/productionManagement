...
use App\Models\Rice\PurchaseChallan;
...
class PurchaseChallanController extends HomeController {
    ...
    public function index() {
        ...
        return view('rice.purchase_challan.index', compact('dataset'));
    }
    ...
    public function order_list() {
        ...
        return view('rice.purchase_challan.order_list', compact('dataset', 'product', 'drawer'));
    }
    ...
    public function create() {
        ...
        return view('rice.purchase_challan.create', compact('categories', 'subheads', 'empty_bag_weight'));
    }
    ...
    public function store(Request $r) {
        ...
        $model->main_weight = $r->main_weight;
        $model->bag_quantity = $r->bag_quantity;
        $model->net_weight = $r->net_weight;
        $model->empty_bag_weight = $r->empty_bag_weight;
        $model->dhorla = $r->dhorla;
        $model->net_mon = $r->net_mon;
        $model->per_mon_price = $r->per_mon_price;
        ...
        try {
            ...
            $modelStock->weight = $model->main_weight;
            $modelStock->mon = $model->net_mon;
            ...
            DB::commit();
            return redirect('/rice/purchase-challan')->with('success', 'New Record Created Successfully.');
        } catch (Exception $e) {
            DB::rollback();
    ...
    public function show($id) {
        ...
        return view('rice.purchase_challan.details', compact('data'));
    }
    ...
    public function edit($id) {
        ...
        return view('rice.purchase_challan.edit', compact('data', 'categories', 'subheads', 'products', 'particulars', 'empty_bag_weight'));
    }
    ...
    public function update(Request $r, $id) {
        ...
        try {
            ...
            DB::commit();
            return redirect('rice/purchase-challan')->with('success', 'Purchase Challan Updated Successfully.');
        } catch (Exception $e) {
            DB::rollback();
            return redirect()->back()->with('danger', $e->getMessage());
        }
    ...
    public function search(Request $r) {
        ...
        return view('rice.purchase_challan._list', compact('dataset'));
    }
