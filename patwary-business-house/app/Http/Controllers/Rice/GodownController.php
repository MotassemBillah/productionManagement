...
class GodownController extends HomeController {
    ...
    public function index() {
        ...
        return view('rice.godowns.index', compact('dataset', 'insList'));
    }

    public function create() {
        //check_user_access('supplier_create');
        $insList = Institute::where([['type', 'institute'], ['business_type_id', RICEMILL]])->get();
        return view('rice.godowns.create', compact('ins'));
    }
    ...
    public function store(Request $r) {
        ...
        try {
            ...
            DB::commit();
            return redirect('rice/godowns')->with('success', 'New Record Created Successfully.');
        } catch (Exception $e) {
            DB::rollback();
    ...
    public function edit($id) {
        ...
        $data = Godown::find($id);
        return view('rice.godowns.edit', compact('data'));
    }
    ...
    public function update(Request $r, $id) {
        ...
        try {
            ...
            DB::commit();
            return redirect('rice/godowns')->with('success', 'Record Updated Successfully.');
        } catch (Exception $e) {
            DB::rollback();
            return redirect()->back()->with('danger', $e->getMessage());
        }
    ...
    public function search(Request $r) {
        ...
        $dataset = $query->paginate($this->getSettings()->pagesize);
        return view('rice.godowns._list', compact('dataset'));
    }
