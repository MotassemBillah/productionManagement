...
class FinishProductController extends HomeController {
    ...
    public function index() {
        ...
        return view('oven.finish_products.index', compact('dataset', 'categories'));
    }

    public function create() {
        adminMsg();
        $category = new Category();
        return view('oven.products.create', compact('category'));
    }
    ...
    public function search(Request $r) {
        ...
        return view('oven.finish_products._list', compact('dataset', 'categories'));
    }
