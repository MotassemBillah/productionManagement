...
class SalesChallanController extends HomeController {
    ...
    public function index() {
        ...
        return view('oven.sales_challan.index', compact('dataset'));
    }

    public function details() {
        $dataset = SalesChallanItem::where('type', 'out')->orderBy('date', 'DESC')->paginate($this->getSettings()->pagesize);
        return view('oven.sales_challan.items', compact('dataset'));
    }
    ...
    public function create() {
        ...
        return view('oven.sales_challan.create', compact('products', 'subheads', 'category'));
    }
    ...
    public function store(Request $r) {
        ...
        try {
            ...
            DB::commit();
            return redirect('/oven/sales-challan')->with('success', 'New Record Created Successfully.');
        } catch (Exception $e) {
            DB::rollback();
    ...
    public function show($id) {
        ...
        return view('oven.sales_challan.details', compact('data'));
    }
    ...
    public function edit($id) {
        ...
        return view('oven.sales_challan.edit', compact('data', 'categories', 'products', 'subheads', 'particulars'));
    }
    ...
    public function update(Request $r, $id) {
        ...
        try {
            ...
            DB::commit();
            return redirect('oven/sales-challan')->with('success', 'Sales Challan Updated Successfully.');
        } catch (Exception $e) {
            DB::rollback();
            return redirect()->back()->with('danger', $e->getMessage());
        }
    ...
    public function search(Request $r) {
        ...
        return view('oven.sales_challan._list', compact('dataset'));
    }
    ...
    public function search_items(Request $r) {
        ...
        $dataset = $query->orderBy('date', 'DESC')->paginate($item_count);
        return view('oven.sales_challan.item_list', compact('dataset'));
    }
