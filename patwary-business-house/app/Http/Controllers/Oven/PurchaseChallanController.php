...
class PurchaseChallanController extends HomeController {
    ...
    public function index() {
        ...
        return view('oven.purchase_challan.index', compact('dataset'));
    }

    public function details() {
        $dataset = PurchaseChallanItem::where('type', 'in')->orderBy('date', 'DESC')->paginate($this->getSettings()->pagesize);
        return view('oven.purchase_challan.items', compact('dataset'));
    }

    public function create() {
        $products = Product::where([['type', 'Raw'], ['is_deleted', 0], ['business_type_id', OVENFACTORY]])->get();
        $category = new Category();
        $subheads = SubHead::where([['institute_id', PATWARY_STORE], ['head_id', PATWARY_HEAD_CREDITORS]])->get();
        return view('oven.purchase_challan.create', compact('products', 'subheads', 'category'));
    }
    ...
    public function store(Request $r) {
        ...
        $model->total_weight = array_sum($_POST['net_weight']);
        ...
        try {
            ...
            foreach ($_POST['product'] as $key => $value) {
                ...
                $modelItem->weight = $_POST['weight'][$value];
            ...
            DB::commit();
            return redirect('/oven/purchase-challan')->with('success', 'New Record Created Successfully.');
        } catch (Exception $e) {
            DB::rollback();
    ...
    public function show($id) {
        ...
        return view('oven.purchase_challan.details', compact('data'));
    }
    ...
    public function edit($id) {
        ...
        return view('oven.purchase_challan.edit', compact('data', 'categories', 'products', 'subheads', 'particulars'));
    }
    ...
    public function update(Request $r, $id) {
        ...
        try {
            ...
            DB::commit();
            return redirect('oven/purchase-challan')->with('success', 'Purchase Challan Updated Successfully.');
        } catch (Exception $e) {
            DB::rollback();
            return redirect()->back()->with('danger', $e->getMessage());
        }
    ...
    public function search(Request $r) {
        ...
        return view('oven.purchase_challan._list', compact('dataset'));
    }
    ...
    public function search_items(Request $r) {
        ...
        $dataset = $query->orderBy('date', 'DESC')->paginate($item_count);
        return view('oven.purchase_challan.item_list', compact('dataset'));
    }
