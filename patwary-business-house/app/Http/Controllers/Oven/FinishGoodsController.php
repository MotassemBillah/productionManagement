...
class FinishGoodsController extends HomeController {
    ...
    public function index() {
        check_user_access('oven_manage_finishgoods');
        $dataset = SalesChallan::where('type', 'in')->orderBy('date', 'DESC')->paginate($this->getSettings()->pagesize);
        return view('oven.finishgoods.index', compact('dataset'));
    }
    ...
    public function finishgoodsList() {
        ...
        return view('oven.finishgoods.list', compact('dataset', 'categories'));
    }

    public function create() {
        $products = Product::where([['type', 'Finish'], ['is_deleted', 0], ['business_type_id', OVENFACTORY]])->orderBy('category_id')->get();
        return view('oven.finishgoods.create', compact('products'));
    }
    ...
    public function show($id) {
        ...
        return view('oven.finishgoods.details', compact('data'));
    }

    public function edit($id) {
        $data = SalesChallan::find($id);
        $products = Product::where([['type', 'Finish'], ['is_deleted', 0], ['business_type_id', OVENFACTORY]])->orderBy('category_id')->get();
        return view('oven.finishgoods.edit', compact('data', 'products'));
    }
    ...
    public function update(Request $r, $id) {
        ...
        try {
            ...
            DB::commit();
            return redirect('oven/finishgoods')->with('success', 'Record Updated Successfully.');
        } catch (Exception $e) {
            DB::rollback();
    ...
    public function confirm($id) {
        ...
        try {
            ...
            DB::commit();
            return redirect('oven/finishgoods')->with('success', 'Record Processed Successfully');
        } catch (Exception $e) {
            DB::rollback();
            return redirect()->back()->with('danger', $e->getMessage());
        }
    ...
    public function reset($id) {
        ...
        try {
            ...
            DB::commit();
            return redirect('oven/finishgoods')->with('success', 'SalesChallan Order Reset Successfully');
        } catch (Exception $e) {
            DB::rollback();
            return redirect()->back()->with('danger', $e->getMessage());
        }
    ...
    public function ledger() {
        ...
        return view('oven.finishgoods.ledger', compact('dataset', 'subhead', 'particular', 'category'));
    }
    ...
    public function stocks() {
        ...
        $category = new Category();
        $product = new Product();
        return view('oven.finishgoods.stocks', compact('dataset', 'category', 'product', 'stock'));
    }
    ...
    public function stocks_search(Request $r) {
        ...
        $category = new Category();
        $product = new Product();
        return view('oven.finishgoods.stocks_search', compact('dataset', 'category', 'product'));
    }
...
// Ajax Functions
    public function search(Request $r) {
        ...
        return view('oven.finishgoods._list', compact('dataset'));
    }
    ...
    public function finishgoodsListSearch(Request $r) {
        ...
        $dataset = $query->paginate($item_count);
        return view('oven.finishgoods.list_search', compact('dataset'));
    }
