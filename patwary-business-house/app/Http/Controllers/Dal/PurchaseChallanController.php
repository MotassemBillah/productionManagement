...
class PurchaseChallanController extends HomeController {
    ...
    public function index() {
        ...
        return view('dal.purchase_challan.index', compact('dataset'));
    }

    public function details() {
        $dataset = PurchaseChallanItem::where('type', 'in')->orderBy('date', 'DESC')->paginate($this->getSettings()->pagesize);
        return view('dal.purchase_challan.items', compact('dataset'));
    }

    public function create() {
        $products = Product::where([['type', 'Raw'], ['is_deleted', 0], ['business_type_id', DALMILL]])->get();
        $category = new Category();
        $subheads = SubHead::where([['institute_id', PATWARY_STORE], ['head_id', PATWARY_HEAD_CREDITORS]])->get();
        return view('dal.purchase_challan.create', compact('products', 'subheads', 'category'));
    }
    ...
    public function store(Request $r) {
        ...
        try {
            ...
            DB::commit();
            return redirect('/dal/purchase-challan')->with('success', 'New Record Created Successfully.');
        } catch (Exception $e) {
            DB::rollback();
    ...
    public function show($id) {
        ...
        return view('dal.purchase_challan.details', compact('data'));
    }
    ...
    public function edit($id) {
        ...
        return view('dal.purchase_challan.edit', compact('data', 'categories', 'products', 'subheads', 'particulars'));
    }
    ...
    public function update(Request $r, $id) {
        ...
        try {
            ...
            DB::commit();
            return redirect('dal/purchase-challan')->with('success', 'Purchase Challan Updated Successfully.');
        } catch (Exception $e) {
            DB::rollback();
            return redirect()->back()->with('danger', $e->getMessage());
        }
    ...
    public function search(Request $r) {
        ...
        return view('dal.purchase_challan._list', compact('dataset'));
    }
    ...
    public function search_items(Request $r) {
        ...
        $dataset = $query->orderBy('date', 'DESC')->paginate($item_count);
        return view('dal.purchase_challan.item_list', compact('dataset'));
    }
