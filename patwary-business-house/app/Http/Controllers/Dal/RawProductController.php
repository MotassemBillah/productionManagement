...
class RawProductController extends HomeController {
    ...
    public function index() {
        $model = new Product();
        $query = $model->where([['type', 'Raw'], ['is_deleted', 0], ['business_type_id', DALMILL]]);
        ...
        return view('dal.raw_products.index', compact('dataset', 'categories'));
    }

    public function create() {
        adminMsg();
        $category = new Category();
        return view('dal.raw_products.create', compact('category'));
    }
    ...
    public function edit($id) {
        ...
        return view('dal.products.edit', compact('data', 'category'));
    }
    ...
    public function search(Request $r) {
        ...
        $query = Product::query();
        $query->where([['type', 'Raw'], ['is_deleted', 0], ['business_type_id', DALMILL]]);
        if (!empty($sort_by)) {
        ...
        $dataset = $query->paginate($this->getSettings()->pagesize);
        $categories = Category::where([['is_deleted', 0], ['business_type_id', DALMILL]])->get();
        return view('dal.raw_products._list', compact('dataset', 'categories'));
    }
