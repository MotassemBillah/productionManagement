...
class RawCategoryController extends HomeController {
    ...
    public function index() {
        ...
        return view('dal.raw_category.index', compact('dataset'));
    }

    public function create() {
        adminMsg();
        return view('dal.raw_category.create');
    }
    ...
    public function store(Request $r) {
        ...
        try {
            ...
            DB::commit();
            return redirect('dal/rawcategory')->with('success', 'New Record Created Successfully.');
        } catch (Exception $e) {
            DB::rollback();
    ...
    public function edit($id) {
        ...
        return view('dal.rawcategory.edit', compact('data'));
    }
    ...
    public function update(Request $r, $id) {
        ...
        try {
            ...
            DB::commit();
            return redirect('dal/rawcategory')->with('success', 'Category Updated Successfully.');
        } catch (Exception $e) {
            DB::rollback();
            return redirect()->back()->with('danger', $e->getMessage());
        }
    ...
    public function search(Request $r) {
        ...
        return view('dal.raw_category._list', compact('dataset'));
    }
