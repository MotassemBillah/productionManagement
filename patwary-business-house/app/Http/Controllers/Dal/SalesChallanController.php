...
class SalesChallanController extends HomeController {
    ...
    public function index() {
        ...
        return view('dal.sales_challan.index', compact('dataset'));
    }

    public function details() {
        $dataset = SalesChallanItem::where('type', 'out')->orderBy('date', 'DESC')->paginate($this->getSettings()->pagesize);
        return view('dal.sales_challan.items', compact('dataset'));
    }

    public function create() {
        $products = Product::where([['type', 'Finish'], ['is_deleted', 0], ['business_type_id', DALMILL]])->get();
        $category = new Category();
        $subheads = SubHead::where([['institute_id', PATWARY_STORE], ['head_id', PATWARY_HEAD_DEBTORS]])->get();
        return view('dal.sales_challan.create', compact('products', 'subheads', 'category'));
    }
    ...
    public function store(Request $r) {
        ...
        try {
            ...
            DB::commit();
            return redirect('/dal/sales-challan')->with('success', 'New Record Created Successfully.');
        } catch (Exception $e) {
            DB::rollback();
    ...
    public function show($id) {
        ...
        return view('dal.sales_challan.details', compact('data'));
    }
    ...
    public function edit($id) {
        ...
        return view('dal.sales_challan.edit', compact('data', 'categories', 'products', 'subheads', 'particulars'));
    }
    ...
    public function update(Request $r, $id) {
        ...
        try {
            ...
            DB::commit();
            return redirect('dal/sales-challan')->with('success', 'Sales Challan Updated Successfully.');
        } catch (Exception $e) {
            DB::rollback();
            return redirect()->back()->with('danger', $e->getMessage());
        }
    ...
    public function search(Request $r) {
        ...
        return view('dal.sales_challan._list', compact('dataset'));
    }
    ...
    public function search_items(Request $r) {
        ...
        $dataset = $query->orderBy('date', 'DESC')->paginate($item_count);
        return view('dal.sales_challan.item_list', compact('dataset'));
    }
