...
class FinishProductController extends HomeController {
    ...
    public function index() {
        ...
        return view('dal.finish_products.index', compact('dataset', 'categories'));
    }

    public function create() {
        adminMsg();
        $category = new Category();
        return view('dal.products.create', compact('category'));
    }
    ...
    public function search(Request $r) {
        ...
        return view('dal.finish_products._list', compact('dataset', 'categories'));
    }
