...
class StockRegisterController extends HomeController {
    ...
    public function index() {
        ...
        return view('flour.stock_register.index', compact('purchases', 'sales', 'empty_bag_rec', 'empty_bag_pay'));
    }
    ...
    public function search(Request $r) {
        ...
        $empty_bag_rec = $modelEmptyBag->totalReceiveByDate();
        $empty_bag_pay = $modelEmptyBag->totalPaymentByDate();
        return view('flour.stock_register._list', compact('purchases', 'sales', 'empty_bag_rec', 'empty_bag_pay'));
    }
