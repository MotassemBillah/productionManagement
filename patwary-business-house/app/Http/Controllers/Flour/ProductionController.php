...
class ProductionController extends HomeController {
    ...
    public function index() {
        check_user_access('flour_manage_production');
        ...
        return view('flour.production.index', compact('dataset'));
    }

    public function order_list() {
        check_user_access('flour_manage_production');
        $drawer = new Drawer();
        $dataset = Production::orderBy('date', 'DESC')->paginate($this->getSettings()->pagesize);
        return view('flour.production.order_list', compact('dataset', 'drawer'));
    }
    ...
    public function create() {
        ...
        return view('flour.production.create', compact('products', 'category', 'stock', 'drawers'));
    }
    ...
    public function show($id) {
        ...
        return view('flour.production.details', compact('data', 'category', 'products', 'drawer'));
    }
    ...
    public function edit($id) {
        ...
        $category = new Category();
        $product = new Product();
        return view('flour.production.edit', compact('data', 'stocks', 'category', 'product', 'drawers'));
    }
    ...
    public function update(Request $r, $id) {
        ...
        $input = $r->all();
        $rule = array(
            'order_no' => 'required|unique:flour_production,order_no,' . $id,
            'date' => 'required',
        );
        $messages = array(
        ...
        try {
            ...
            DB::commit();
            return redirect('flour/production')->with('success', 'Production Order Updated Successfully.');
        } catch (Exception $e) {
            DB::rollback();
    ...
    public function confirm($id) {
        ...
        try {
            ...
            DB::commit();
            return redirect('flour/production')->with('success', 'Production Order Processed Successfully');
        } catch (Exception $e) {
            DB::rollback();
            return redirect('flour/production')->with('danger', $e->getMessage());
        }
    }
    ...
    public function order_items($id) {
        if (isset($id)) {
            ...
            $category = new Category();
            $product = new Product();
            return view('flour.production.item', compact('dataset', 'category', 'product', 'drawer'));
        }
    }
    ...
    public function order_complete($id) {
        if (isset($id)) {
            ...
            return view('flour.production.after_production', compact('products', 'production_item'));
        }
    }
    ...
    public function search(Request $r) {
        ...
        return view('flour.production._list', compact('dataset'));
    }
    ...
    public function order_list_search(Request $r) {
        ...
        $drawer = new Drawer();
        $dataset = $query->orderBy('date', 'DESC')->paginate($item_count);
        return view('flour.production.order_list_search', compact('dataset', 'drawer'));
    }
