...
class ProductController extends HomeController {
    ...
    public function index() {
        ...
        return view('flour.products.index', compact('dataset', 'categories'));
    }

    public function create() {
        adminMsg();
        $category = new Category();
        return view('flour.products.create', compact('category'));
    }
    ...
    public function edit($id) {
        ...
        return view('flour.products.edit', compact('data', 'category'));
    }
    ...
    public function search(Request $r) {
        ...
        return view('flour.products._list', compact('dataset', 'categories'));
    }
