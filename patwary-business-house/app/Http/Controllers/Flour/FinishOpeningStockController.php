...
class FinishOpeningStockController extends HomeController {
    ...
    public function index() {
        ...
        if (!empty($data)) {
            $dataset = $data;
            return view('flour.finish_opening_stocks.index', compact('dataset', 'category', 'product'));
        } else {
            $dataset = Product::where([['type', 'Finish'], ['is_deleted', 0], ['business_type_id', FLOURMILL]])->get();
            return view('flour.finish_opening_stocks.create', compact('dataset', 'category', 'product'));
        }
    }
    ...
    public function create() {
        ...
        $category = new Category();
        return view('flour.finish_opening_stocks.create', compact('dataset', 'category'));
    }
    ...
    public function store(Request $r) {
        ...
        try {
            ...
            $resp['url'] = url('flour/finish-opening-stocks');
        } catch (Exception $e) {
            DB::rollback();
            $resp['success'] = false;
    ...
    public function search(Request $r) {
        ...
        return view('flour.production_stocks._list', compact('dataset', 'category', 'product', 'stock'));
    }
