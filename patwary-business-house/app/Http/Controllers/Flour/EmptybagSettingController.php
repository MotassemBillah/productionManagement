...
class EmptybagSettingController extends HomeController {
    ...
    public function index() {
        ...
        return view('flour.emptybag_setting.index', compact('dataset', 'insList'));
    }

    public function create() {
        //check_user_access('supplier_create');
        $insList = Institute::where([['type', 'institute'], ['business_type_id', FLOURMILL]])->get();
        return view('flour.emptybag_setting.create', compact('insList'));
    }
    ...
    public function store(Request $r) {
        ...
        try {
            ...
            DB::commit();
            return redirect('flour/emptybag-setting')->with('success', 'New Record Created Successfully.');
        } catch (Exception $e) {
            DB::rollback();
    ...
    public function edit($id) {
        ...
        return view('flour.emptybag_setting.edit', compact('data'));
    }
    ...
    public function update(Request $r, $id) {
        ...
        try {
            ...
            DB::commit();
            return redirect('flour/emptybag-setting')->with('success', 'Record Updated Successfully.');
        } catch (Exception $e) {
            DB::rollback();
            return redirect()->back()->with('danger', $e->getMessage());
        }
...
//        }
        ...
        $dataset = $query->paginate($this->getSettings()->pagesize);
        return view('flour.emptybag_setting._list', compact('dataset'));
    }
