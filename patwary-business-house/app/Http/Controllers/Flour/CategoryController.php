...
class CategoryController extends HomeController {
    ...
    public function index() {
        $model = new Category();
        $query = $model->where([['type', 'Raw'], ['is_deleted', 0], ['business_type_id', FLOURMILL]]);
        $dataset = $query->paginate($this->getSettings()->pagesize);
        return view('flour.category.index', compact('dataset'));
    }

    public function create() {
        adminMsg();
        return view('flour.category.create');
    }
    ...
    public function store(Request $r) {
        ...
        try {
            ...
            DB::commit();
            return redirect('flour/category')->with('success', 'New Record Created Successfully.');
        } catch (Exception $e) {
            DB::rollback();
    ...
    public function edit($id) {
        ...
        return view('flour.category.edit', compact('data'));
    }
    ...
    public function update(Request $r, $id) {
        ...
        try {
            ...
            DB::commit();
            return redirect('flour/category')->with('success', 'Category Updated Successfully.');
        } catch (Exception $e) {
            DB::rollback();
            return redirect()->back()->with('danger', $e->getMessage());
        }
    ...
    public function search(Request $r) {
        ...
        return view('flour.category._list', compact('dataset'));
    }
