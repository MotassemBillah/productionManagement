...
class EmptyBagController extends HomeController {
    ...
    public function index() {
        ...
        return view('flour.emptybags.index', compact('dataset', 'subhead'));
    }

    public function create($tp) {
        $heads = SubHead::where('institute_id', institute_id())->get();
        return view('flour.emptybags.create', compact('tp', 'heads'));
    }
    ...
    public function store(Request $r) {
        ...
        $rule = array(
            'date' => 'required',
            'type' => 'required',
            'per_bag_pflour' => 'required',
            'quantity' => 'required',
            'frm_subhead' => 'required',
            'to_subhead' => 'required',
            'total_pflour' => 'required',
        );
        $messages = array(
            ...
            'per_bag_pflour.required' => 'You must provide Per Bag Pflour',
        );
        ...
        $model->per_bag_pflour = $r->per_bag_pflour;
        $model->total_pflour = $r->total_pflour;
        ...
        try {
            ...
            $transaction->debit = $model->total_pflour;
            $transaction->credit = $model->total_pflour;
            $transaction->amount = $model->total_pflour;
    ...
    public function edit($id) {
        ...
        return view('flour.emptybags.edit', compact('data', 'heads', 'particular'));
    }

    public function show($id) {
        $data = EmptyBag::find($id);
        $subhead = new SubHead();
        return view('flour.emptybags.view', compact('data', 'subhead'));
    }
    ...
    public function search(Request $r) {
        ...
        $subhead = new SubHead();
        return view('flour.emptybags._list', compact('dataset', 'subhead'));
    }
