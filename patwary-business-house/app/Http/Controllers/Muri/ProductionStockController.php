...
class ProductionStockController extends HomeController {
    ...
    public function index() {
        ...
        return view('Admin.production_stocks.index', compact('dataset', 'drawer'));
    }

    public function create() {
        check_user_access('production_stocks');
        $production_order = ProductionOrderItem::where([['process_status', '=', 1], ['stock_status', '=', 0],])->groupBy('production_id')->get();
        return view('Admin.production_stocks.create', compact('production_order'));
    }
    ...
    public function store(Request $r) {
        ...
        try {
            foreach ($_POST['item'] as $item) {
                $pmodel = ProductionOrderItem::find($item);
...
//                    }
            ...
            $resp['url'] = url('production-stocks');
        } catch (Exception $e) {
            DB::rollback();
            $resp['success'] = false;
    ...
    public function show($id) {
        ...
        $drawer = new Drawer();
        return view('Admin.production_stocks.view', compact('data', 'category', 'products', 'drawer'));
    }
    ...
    public function edit($id) {
        ...
        return view('Admin.production_stocks.edit', compact('data', 'drawer_info'));
    }
    ...
    public function update(Request $r, $id) {
        ...
        try {
            ...
            DB::commit();
            return redirect('production-stocks')->with('success', 'Production Stocks Updated Successfully.');
        } catch (Exception $e) {
            DB::rollback();
    ...
    public function stocks() {
        ...
        return view('Admin.production_stocks.stocks', compact('dataset', 'category', 'product', 'stock'));
    }
    ...
    public function details() {
        ...
        return view('Admin.production_stocks.details', compact('dataset', 'product', 'drawer'));
    }
    ...
    public function search(Request $r) {
        ...
        $drawer = new Drawer;
        return view('Admin.production_stocks._list', compact('dataset', 'drawer'));
    }
    ...
    public function stocks_search(Request $r) {
        ...
        $product = new AfterProduction();
        $stock = new ProductionStockItem();
        return view('Admin.production_stocks.stocks_list', compact('dataset', 'category', 'product', 'stock'));
    }
    ...
    public function details_search(Request $r) {
        ...
        return view('Admin.production_stocks.details_search', compact('dataset', 'product', 'drawer'));
    }
