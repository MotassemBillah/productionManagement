...
class SalesChallan extends Model {
    ...
    protected $table = 'dal_sales_challan';
    public $timestamps = false;

    public function items() {
        return $this->hasMany('App\Models\Dal\SalesChallanItem', 'sales_challan_id', 'id');
    }

    public static function get_finishgoods_invoice() {
        $invpre = 'FG-';
        $data = DB::table('dal_sales_challan')->where('type', '=', 'in')->orderBy('id', 'desc')->first();
