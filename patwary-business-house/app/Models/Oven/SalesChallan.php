...
class SalesChallan extends Model {
    ...
    protected $table = 'oven_sales_challan';
    public $timestamps = false;

    public function items() {
        return $this->hasMany('App\Models\Oven\SalesChallanItem', 'sales_challan_id', 'id');
    }

    public static function get_finishgoods_invoice() {
        $invpre = 'FG-';
        $data = DB::table('oven_sales_challan')->where('type', '=', 'in')->orderBy('id', 'desc')->first();
