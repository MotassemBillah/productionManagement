...
class PurchaseChallan extends Model {
    ...
    protected $table = 'oven_purchase_challan';
    public $timestamps = false;

    public function items() {
        return $this->hasMany('App\Models\Oven\PurchaseChallanItem', 'purchase_challan_id', 'id');
    }

    public static function get_production_invoice() {
        $invpre = 'SR-';
        $data = DB::table('oven_purchase_challan')->where('type', '=', 'out')->orderBy('id', 'desc')->first();
