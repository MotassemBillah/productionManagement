...
class SaleReturn extends Model {
    ...
    protected $table = 'inv_sale_return';
    public $timestamps = false;

    public function items() {
        return $this->hasMany('App\Models\Inv\SaleReturnItem', 'sale_return_id', 'id')->where('is_deleted', '=', 0);
    }

    public function stocks() {
        return $this->hasMany('App\Models\Inv\Stock', 'sale_return_id', 'id')->where('is_deleted', '=', 0);
    }

    public function avg_price_list() {
        return $this->hasMany('App\Models\Inv\AvgPrice', 'sale_return_id', 'id')->where('is_deleted', '=', 0);
    }
