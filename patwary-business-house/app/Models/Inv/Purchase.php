...
class Purchase extends Model {
    ...
    public function items() {
        return $this->hasMany('App\Models\Inv\PurchaseItem', 'purchase_id', 'id')->where('is_deleted', '=', 0);
    }

    public function stocks() {
        return $this->hasMany('App\Models\Inv\Stock', 'purchase_id', 'id')->where('is_deleted', '=', 0);
    }

    public function avg_price_list() {
        return $this->hasMany('App\Models\Inv\AvgPrice', 'purchase_id', 'id')->where('is_deleted', '=', 0);
    }
